...
exports.createEventTicketPaymentIntent =
  exports.createMessagePaymentIntent =
  exports.checkExpiredPayments =
...
async function checkAndUpdateMatchPaymentStatus(matchId) {
  ...
  try {
    ...
    const user2Payment = matchPaymentData.user2PaymentId
      ...
      : null;
    const user1Paid =
      (user1Payment === null || user1Payment === void 0
        ? void 0
        : user1Payment.exists) &&
      ((_a = user1Payment.data()) === null || _a === void 0
        ? void 0
        : _a.status) === "paid";
    const user2Paid =
      (user2Payment === null || user2Payment === void 0
        ? void 0
        : user2Payment.exists) &&
      ((_b = user2Payment.data()) === null || _b === void 0
        ? void 0
        : _b.status) === "paid";
...
exports.checkExpiredPayments = (0, scheduler_1.onSchedule)(
  "every 6 hours",
  async event => {
    const stripe = new stripe_1.default(process.env.STRIPE_SECRET_KEY || "", {
      apiVersion: "2025-07-30.basil",
...
exports.createMessagePaymentIntent = (0, https_1.onCall)(
  async (data, context) => {
    ...
    try {
      ...
      const userId =
        ((_a =
          context === null || context === void 0 ? void 0 : context.auth) ===
          null || _a === void 0
          ? void 0
          : _a.uid) ||
        ((_b = data.data) === null || _b === void 0 ? void 0 : _b.userId) ||
        data.userId;
